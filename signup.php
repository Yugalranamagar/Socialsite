...
<html>
	...
	<head>
		<title>Welcome  To Beta Social Site- Sign up, Log in, Chat </title>
	...
	<div id="container">
		...
		<form method="post" action="signup_form.php" enctype="multipart/form-data">
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					<td><input type="text" name="firstname" placeholder="Enter your firstname....." class="form-1" title="Enter your firstname" required <br></td>
		...
		<br />
			...
			<strong>Yes, I have read and I accept the <a href="#">Beta Terms of Use</a> and the <a href="#">Beta Privacy Statement</a></strong>
