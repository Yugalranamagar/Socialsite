...
<html>
	...
	<head>
		<title>Welcome  To Beta - Sign up, Log in, Post </title>
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Biobook"><b>Beta</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
				...
				<li><a href="chat.php" title="Settings"><label>Chat</label></a></li>
...
?>
		 ...
		 <form  method="POST" action="comment.php">			
			<div class="comment-area">
						...
						<?php 
						$con=mysqli_connect("localhost","root","","biobook");
						$image=mysqli_query($con,"select * from user where user_id='$id'")or die(mysqli_error());
